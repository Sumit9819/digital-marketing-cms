...
```bash
git remote add encore encore://digital-marketing-cms-ydvi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/digital-marketing-cms-ydvi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/digital-marketing-cms-ydvi/settings/integrations/github)
